...
//Khai bao so luong sach va doc gia sach max
#define MaxSach 1000
#define MaxDG 300
...
/*
	Nhan vao: MSMuon[MaxDG][25]; ISBNMuon[MaxSach][30]; ngaymuon[MaxSach]; thangmuon[MaxSach]; nammuon[MaxSach];
	Tra ve: Thong tin phieu muon
*/
void NhapPhieuMuon()
{
	while (true)
...
//Ham tinh thoi gian tra du kien
/*
	Nhan vao: ngaymuon,thangmuon,nammuon
	Tra ve: Cac gia tri ngaytraDK, thangtraDK, namtraDK
*/
void ThoiGianTraDuKien()
{
	//Xac dinh so ngay thuc te tu thang muon nhap vao
	int SNTT;
	...
	else
	{
		...
		if (ngaytraDK[n - 1] > SNTT)				//Neu ngaytraDK vuot qua SNTT(30 or 31 ngay) thi thuc hien khoi lenh nay
		{
			...
			if (ngaytraDK[n - 1] == 0)				//Neu ngaytraDK =! SNTT(30 or 31 ngay) thi khong thuc hien lenh nay
			{
				ngaytraDK[n - 1] = SNTT;
...
void XuatPhieuMuon()
{
	...
	printf("\n LUU Y: ");
	printf("\n+  Doc gia tre han tra sach (7 ngay ke tu ngay muon sach) cho thu vien se phat 5000d/1ngaytre. Vui long thuc hien dung quy dinh.");
...
/*
	Nhan vao: MSMuon[MaxDG][25];
	Tra ve: Thong tin phieu tra
*/
void NhapPhieuTra()
{
	while (true)
...
//Ham tinh tien phat
/*
	Nhan vao: ngaytraDK,thangtraDK,namtraDK,ngaytraTT,thangtraTT,namtraTT
	Tra ve: So tien phat
*/
...
void LapPhieuMuonTra()
{
	while (true)
	{
		printf("\n					 TUY CHON LAP PHIEU MUON TRA					\n");
		printf("\t[57]:Thoat lap phieu .\n");
		printf("\t[58]:Lap phieu muon sach.\n");
		printf("\t[59]:Lap phieu tra sach.\n");
		printf("																			\n");
		...
		case 59:
			...
			break;
		default:
			printf("Chuc nang khong ton tai, xin hay chon lai.");
			break;
		}
	}
}
//Ham xuat thong ke so luong sach da muon

//Tra ve: So luong sach doc gia da muon
...
//Ham xuat thong ke so luong sach tre han
/*
	Nhan vao: ngaytraTT; ngaytraDK; thangtraTT; thangtraDK; namtraTT; namtraDK;
	Tra ve: So luong doc gia tre han
*/
int TKDGTreHan()
{
	int dem = 0;
